...
<html>
	...
	<body>
	    ...
	    <c:choose>
	    	...
	    	<c:otherwise>
	    		<section id="computerNotFound">
			        <div class="container" style="margin-top: 15px;">
			            <div class="row">
			            	<div class="col-xs-8 col-xs-offset-2 box">
						    	<div class="alert alert-danger" role="alert">${computerNotFoundMessage} <a href="dashboard">Go back to dashboard.</a></div>
					       	</div>
		       			</div>
		       		</div>
			    </section>
